...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-little-me-part-i",
        
          title: 'Little Me, Part I <svg width="1.2rem" height="1.2rem" top=".5rem" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"><path d="M17 13.5v6H5v-12h6m3-3h6v6m0-6-9 9" class="icon_svg-stroke" stroke="#999" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        
        description: "Trying to reflect on years 1-15...",
        section: "Posts",
        handler: () => {
          
            window.open("https://hudsonmp.substack.com/p/little-me-part-i", "_blank");
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-studying-for-ap-exams-and-sat",
          title: 'Studying for AP Exams and SAT.',
          description: "",
          section: "News",},{id: "news-emergent-ventures-grantee-for-research",
          title: 'Emergent Ventures grantee for research.',
          description: "",
          section: "News",},{id: "news-research-position-with-professor-david-h-smith-iv-at-virginia-tech-this-summer",
          title: 'Research position with Professor David H. Smith IV at Virginia Tech this summer....',
          description: "",
